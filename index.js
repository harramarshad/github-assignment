...
let currentUser = ["Diana", "Sofia", "Lara", "Bryan", "Bella"];
let newUsers = ["Rolph", "Grey", "Lara", "Bob", "Diana"];
...
let favouritePizza = ["CheesePizza", "PepperoniPizza", "Pineapple Pizza"];
...
//problem38.Cities.
function describeCity(nameofCity, itsCountry) {
...
//problem39.City name.
function cityCountry(nameofCity, itsCountry) {
...
//problem45.Cars.
function CreateCar(maufacture, model, option) {
    return Object.assign({ maufacture, model }, option);
}
;
